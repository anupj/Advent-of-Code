...
// takes the string "2-4"
// and returns a RangeInclusive version
// ("", 2..=4)
...
// RangeInclusive representation of input
// (2..=4, 6..=8)
...
fn section_assignments(
    ...
    let (input, ranges) = separated_list1(character::complete::newline, line)(input)?;
